...
/*   Updated: 2021/05/23 16:34:57 by mbeaujar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void example(t_prompt *prompt, t_command *ptr); // exmample

void display_all_pipe_fd(int *fd, int len); // not norminette (for)
